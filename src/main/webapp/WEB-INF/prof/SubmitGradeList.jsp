	...
	<table align="center">
		...
		<c:forEach var="row" items="${teachingOffers}">
			<tr>
				...
				<td>
					<form style="text-align: center" action="/bagh/prof/SubmitGrade.jsp" method="POST">
						<input class="btn-custom" type="submit" value="Grading" />
