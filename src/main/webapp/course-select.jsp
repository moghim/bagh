...
Some Examples! (you can probably do better than these, though)
    ...
    <style>	
	  ...
	  textarea { height:25px; }
	    body {background-image:url('bluepap.jpg');}
	</style>
  ...
  <body>
  <c:if test="${err == '1'}">
    <h4 align="center">Unsuccessful Command :<br>${errMessage}</h4>
  </c:if>
  <c:url var="myUrl" value="CourseSelect.action">
   <c:param name="sid" value="${sid}"/>
  </c:url>
    <h3 style="text-align:center">Student Name : ${sname}</h3><br>
    
    <h4 style="text-align:center">Selected Courses</h4> 
      <table align="center" class="success">
      <tr>
	      <th style="width:10px">Offering ID</th>
        ...
        <c:forEach var="offer" items="${inprogressOffer}">
    	  <tr>
    ...
    <h4 style="text-align:center">Term Offers</h4>     
      <table  align="center">
       <tr class="success">
	      <th style="width:10px">Offering ID</th>
	      <th style="width:240px">Course</th>
